 ...
 * currently being viewed in a {@link SalesOrderDetailFragment}.
 * <p></p>
...
public class SalesOrderItemListFragment extends ListFragment
{
    ...
    public void onAttach(Activity activity)
    {
        ...
        {
            throw new IllegalStateException(activity.getString(R.string.error_msg_SalesOrderListFragment_onAttach));
        }
