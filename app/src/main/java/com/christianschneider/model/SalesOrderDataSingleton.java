...
public class SalesOrderDataSingleton
{
    ...
    /** A map of SalesOrder items, the key used is ProductID, but can be changed.
     * This is the same variable name generated by the Android Studio template.
     */
    public static final Map<String, SalesOrder> ITEM_MAP = new HashMap<>();
    ...
    private static ArrayList<SalesOrder> getSalesOrderSets() throws OnlineODataStoreException
    {
        ...
        if (store!=null)
        {
            ...
            try
            {
                 ...
                 *
                 *  Instead of ProductID, you can specify Collections.NOTE to have all products
                 ...
                 *   - http://services.odata.org/V2/christianschneider/christianschneider.svc/Products?$orderby=ProductID
                 *   - http://services.odata.org/V2/christianschneider/christianschneider.svc/Products?$orderby=ProductID&$skiptoken=20,20
                 *   - http://services.odata.org/V2/christianschneider/christianschneider.svc/Products?$orderby=ProductID&$skiptoken=40,40
                 *   - http://services.odata.org/V2/christianschneider/christianschneider.svc/Products?$orderby=ProductID&$skiptoken=60,60
                 */
                ...
                do
                {
                    ...
                    for (ODataEntity entity : entities)
                    {
                        ...
                        salesOrder.setGrossAmount(property.getValue().toString());
