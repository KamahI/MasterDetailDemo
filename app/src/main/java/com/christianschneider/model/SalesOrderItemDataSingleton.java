...
public class SalesOrderItemDataSingleton {
    ...
    public static void createInstance() {
        if (instance == null) {
            // Create the instance
            instance = new SalesOrderItemDataSingleton();
        }
    }
     ...
     */
    private static void storeData(SalesOrder salesOrder) {
    ...
    private static ArrayList<SalesOrderItem> getSalesOrderItems(ODataOpenListener openListener, SalesOrder salesOrder) throws OnlineODataStoreException {
        ...
        if (store != null) {
            ...
            try {
                ...
                storeData(salesOrder);

                Log.d("Marius_ist_super", ITEM_MAP.get("EPM DG: SO ID 0500000000 Item 0000000010").getNote());
     ...
     */
    private SalesOrderItemDataSingleton() {
