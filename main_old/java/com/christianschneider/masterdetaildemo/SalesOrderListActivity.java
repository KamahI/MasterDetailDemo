...
import com.christianschneider.masterdetaildemo.dummy.DummyContent;
...
public class SalesOrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.sales_order_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(v.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        Intent intent = new Intent(context, SalesOrderDetailActivity.class);
                        intent.putExtra(v.ARG_ITEM_ID, holder.mItem.id);
